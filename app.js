...
function showMobiles() {
    for (let el of mobiles){
        str += `<div class='col-md-3'>${el.title}</div>
        <div class='col-md-3'>${el.description}</div>
        <div class='col-md-3'>${el.price}</div>
        <div class='col-md-3'>${`<img src="${el.thumbnail}" alt="" h=700 width=200>`}</div>`
